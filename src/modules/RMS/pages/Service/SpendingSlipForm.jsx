        ...
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4 mt-3">
                    <div className="flex items-center gap-8">
                        <label className="font-bold">Đối tượng nhận</label>
                        <Space wrap>
                            <Select
                                defaultValue="Khác"
                                style={{ width: 295 }}
                    ...
                    <div className="flex items-center gap-8">
                        <label className="font-bold">Tên người nhận</label>
                        <div className="flex">
...
export default SpendingSlipForm;
