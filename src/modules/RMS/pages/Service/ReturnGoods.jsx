...
const ReturnGoods = () => {
    ...
    const handleInventoryClick = () => {
        navigate("/rms/return-goods-form");
    };
    ...
    const content = (
        <div>
            ...
            <div>
                <Checkbox name="totalPrice" checked={checkedItems.totalPrice} onChange={handleCheckboxChange}>
                    Tổng tiền hàng trả
                </Checkbox>
            </div>
            <div>
            ...
            <div>
                <Checkbox name="paidNCC" checked={checkedItems.paidNCC} onChange={handleCheckboxChange}>
                    NCC đã trả
                </Checkbox>
            </div>
        </div>
                            ...
                            <div>
                                <div className="grid grid-cols-2 gap">
                                    <div className=" flex flex-col gap-3">
                                        ...
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">NCC cần trả:</td>
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">NCC đã trả:</td>
                                    </div>
                        ...
                        >
                            ...
                            <Collapse ghost defaultActiveKey={["1", "2", "3", "4", "5"]}>
                                ...
                                <Panel header="Tìm kiếm" key="1" className="bg-white rounded-lg shadow mb-4">
                                    <InputField placeholder="Theo mã phiếu trả" className="mb-2" />
                                    ...
                                    <InputField placeholder="Theo nhân viên trả" className="mb-2" />
                                    <InputField placeholder="Theo tài khoản tạo" className="mb-2" />
                                </Panel>

                                {/* Chi phí nhập hoàn lại */}
                                <Panel
                                    header="Chi phí nhập hoàn lại"
                                    key="5"
                                    className="bg-white rounded-lg shadow mb-4"
                                >
                                    <Space wrap>
                                        <Select
                                            defaultValue="Chọn chi phí nhập hoàn lại"
                                            style={{
                                                width: 200,
                                                color: "gray",
                                            }}
                    ...
                    <Content className="p-6 bg-white">
                        <div className="flex md:flex-row flex-col justify-between mb-4 gap-3">
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-lg font-bold text-gray-700">Phiếu trả hàng nhập</h1>
                            </div>
