...
const CancellationSlip = () => {
    ...
    const handleInventoryClick = () => {
        navigate("/rms/cancellation-slip-form");
    };
    ...
    useEffect(() => {
        const initialCheckedItems = {
            cancellationCode: true, // Mặc định là checked
            time: true,
            branch: true,
        ...
        <div>
            <div>
                <Checkbox
                    ...
                    checked={checkedItems.cancellationCode}
            ...
            <div>
                <Checkbox name="branch" checked={checkedItems.branch} onChange={handleCheckboxChange}>
                    Chi nhánh
                </Checkbox>
            </div>
            <div>
                <Checkbox
                    ...
                    checked={checkedItems.cancellationValue}
                    onChange={handleCheckboxChange}
                >
                    Tổng giá trị hủy
                </Checkbox>
            ...
            <div>
                <Checkbox name="note" checked={checkedItems.note} onChange={handleCheckboxChange}>
                    Ghi chú
                </Checkbox>
            </div>
            <div>
    ...
    const expandedRowRenderCancellationSlip = (record) => {
        return (
                            ...
                            <div>
                                <div className="grid grid-cols-2 gap">
                                    <div className=" flex flex-col gap-3">
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">Mã xuất hủy:</td>
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">Thời gian:</td>
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">Chi nhánh:</td>
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">Tổng giá trị hủy:</td>
                                        <td className="  border-b-[1px] pb-2 !border-gray-300">Ghi chú:</td>
                        ...
                        >
                            ...
                            <Collapse ghost defaultActiveKey={["1", "2", "3", "4", "5"]}>
                                ...
                                <Panel header="Tìm kiếm" key="1" className="bg-white rounded-lg shadow mb-4">
                                    <InputField placeholder="Theo mã xuất hủy" className="mb-2" />
                                    <InputField placeholder="Theo mã, tên hàng" className="mb-2" />
                                    <InputField placeholder="Theo nhân viên xuất hủy" className="mb-2" />
                    ...
                    <Content className="p-6 bg-white">
                        <div className="flex md:flex-row flex-col justify-between mb-4 gap-3">
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-lg font-bold text-gray-700">Phiếu xuất hủy</h1>
                            </div>
                        ...
                        <>
                            <div className="overflow-x-auto">
                                <Table
                                    ...
                                    expandedRowRender={expandedRowRenderCancellationSlip} // Nếu cần mở rộng hàng
